...
def find_by_price_range(min_price: str = '0', max_price: str = '0', skip: int = 0, limit: int = 10):
    return product_service.find_by_price_range(min_price, max_price, skip, limit)
